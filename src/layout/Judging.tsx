...
const Judging = () => {
  ...
  return (
    <div className="border-[#ffffff18] border-b-[1px] w-full px-[30px] md:px-[50px] lg:px-[60px] xl:px-[100px] 2xl:px-[108px] pt-[74px] md:pt-[70px] lg:pt-[70px] xl:pt-[62px] pb-[100px] relative">
      <Image
        src={purpleBg}
        alt="getlinked"
      ...
      >
        <Image
          src={judgeImg}
          alt="getlinked"
          className="h-[100%] md:h-[70%] lg:w-[55%] lg:h-[100%] xl:h-[500px] w-[100%] md:w-[70%] xl:w-[50%] 2xl:w-[55%] object-cover z-10"
        />
        <Image
          src={ellipse}
          alt="getlinked"
          className="absolute hidden xl:block top-[10%] left-[6%] z-0 w-[134px] h-[134px] object-cover"
        />
        <div className="w-[100%] lg:w-[45%] xl:w-[50%] flex flex-col items-center md:items-start">
          <h3 className="text-[20px] md:text-[28px] lg:text-[32px] leading-[135%] w-[167px] md:w-[267px] mx-auto md:mx-0 font-clashDisplay font-bold mb-[16px] md:mb-[21px]">
            Judging Criteria{" "}
            <span className="text-[#D434FE]">Key attributes</span>
          </h3>
          <p className="text-[13px] md:text-[14px] leading-[160%] text-center md:text-left mb-[22px]">
          ...
          <p className="text-[13px] md:text-[14px] leading-[160%] text-center md:text-left mb-[55px]">
            <span className="text-[#FF26B9] font-bold text-[12px] md:text-[16px] leading-[140%]">
