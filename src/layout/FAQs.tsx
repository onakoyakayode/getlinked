...
const FAQs: React.FC = () => {
  return (
    <div
      id="#Faqs"
      className="border-[#ffffff18] border-b-[1px] w-full px-[35px] md:px-[50px] lg:px-[80px] xl:px-[100px] 2xl:px-[168px] pt-[60px] md:pt-[90px] lg:pt-[110px] xl:pt-[120px] pb-[100px] relative"
    >
      <PiStarFourFill
