...
const FAQs: React.FC = () => {
  return (
    <div className="border-[#ffffff18] border-b-[1px] w-full px-[30px] md:px-[50px] lg:px-[80px] xl:px-[100px] 2xl:px-[168px] pt-[60px] md:pt-[90px] lg:pt-[110px] xl:pt-[120px] pb-[100px] relative">
      <PiStarFourFill
      ...
      />
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center lg:gap-24 xl:gap-[50px] w-[100%]">
        <AnimationOnScroll
          animateIn="animate__fadeInLeft"
          className="w-[100%] md:w-[45%] lg:w-[40%] xl:w-[50%] 2xl:w-[45%] mb-[40px] lg:mb-0"
        >
          <h2 className="text-[20px] md:text-[26px] lg:text-[32px] font-bold font-clashDisplay leading-[130%] w-[158px] h-[54px] md:w-[40%] md:h-[68px] lg:h-[86px] lg:w-[253px] mb-[16px]">
            Frequently Ask <span className="text-[#D434FE]">Question</span>
          </h2>
          <p className="text-[12px] md:text-[13px] lg:text-[15px] leading-[130%] md:w-[80%] lg:w-[100%] w-[342px] mb-[68px]">
