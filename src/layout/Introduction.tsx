...
const Introduction = () => {
  return (
    <div className="h-[100dvh] md:h-[80dvh] lg:h-[70dvh] xl:h-[85dvh] 2xl:h-[100dvh] w-full px-[30px] md:px-[50px] lg:px-[80px] xl:px-[100px] 2xl:px-[168px] py-[100px] md:py-[62px] lg:py-[80px] xl:py-[80px] relative border-[#ffffff18] border-b-[1px]">
      <PiStarFourFill
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center gap-[58px] md:gap-[85px] xl:gap-[60px] 2xl:gap-[109px] w-[100%]">
        ...
        >
          <h2 className="w-[249px] h-[54px] mx-auto md:w-[60%] md:h-[77px] lg:w-[450px] xl:w-[398px] 2xl:w-[70%] lg:h-[86px] text-center md:text-left text-[20px] leading-[120%] md:text-[28px] lg:text-[32px] 2xl:text-[36px] mb-[16px] text-pryColor font-bold font-clashDisplay">
            Introduction to getlinked{" "}
            <span className="text-[#D434FE]">tech Hackathon 1.0</span>
          </h2>
          <p className="w-[100%] text-left md:w-[600px] lg:w-[100%] xl:w-[535px] 2xl:w-[85%] md:h-[165px] 2xl:text-[16px] md:text-left text-[13px] md:text-[13.5px] lg:text-[15px] xl:text-[15px] font-normal leading-[150%]">
