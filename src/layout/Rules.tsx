...
const Rules = () => {
  return (
    <div className="h-[95dvh] md:h-[85dvh] lg:h-[80dvh] xl:h-[80dvh] 2xl:h-[85dvh] w-full px-[30px] py-[30px] md:px-[50px] lg:px-[100px] xl:px-[100px] 2xl:px-[168px] md:py-[62px] lg:py-[75px] 2xl:py-[100px] relative border-[#ffffff18] border-b-[1px]">
      <PiStarFourFill
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-[48px] lg:gap-[45px] xl:gap-[48px] w-[100%]">
        ...
        >
          ...
          <p className="text-[13px] md:text-[14px] lg:text-[15px] xl:text-[15px] 2xl:text-[16px] 2xl:w-[80%] leading-[150%]">
