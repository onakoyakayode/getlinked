...
const Rules = () => {
  return (
    <div className="h-[95dvh] md:h-[85dvh] lg:h-[80dvh] xl:h-[80dvh] w-full px-[30px] py-[30px] md:px-[50px] lg:px-[100px] xl:px-[100px] 2xl:px-[168px] md:py-[62px] lg:py-[75px] relative border-[#ffffff18] border-b-[1px]">
      <PiStarFourFill
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-[48px] lg:gap-[45px] xl:gap-[48px] w-[100%]">
        <AnimationOnScroll
          ...
          className="w-[100%] md:w-[35%] lg:w-[40%] xl:w-[50%]"
        >
          <h3 className="font-bold text-[20px] mx-auto md:mx-0 self-center leading-[130%] md:text-[29px] lg:text-[32px] font-clashDisplay w-[107px] md:w-[170px] mb-[9px] md:mb-[16px]">
            Rules and <span className="text-[#D434FE]">Guidelines</span>
          </h3>
          <p className="text-[13px] md:text-[14px] lg:text-[15px] xl:text-[15px] leading-[150%]">
        ...
        <AnimationOnScroll
          ...
          className="w-[100%] md:w-[65%] lg:w-[60%] xl:w-[50%]"
        >
