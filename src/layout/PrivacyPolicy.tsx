  ...
  return (
    ...
    >
      ...
      <div className="w-[100%] flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-[20px] md:gap-[50px] lg:gap-[60px] xl:gap-[103px] relative">
        ...
        >
          <h1 className="text-center md:text-left text-[20px] md:text-[26px] lg:text-[32px] 2xl:text-[51px] 2xl:w-[53%] leading-[130%] mx-auto md:mx-0 font-clashDisplay font-bold w-[188px] md:w-[300px] mb-[17px]">
            Privacy Policy and <span className="text-[#D434FE]">Terms</span>
          </h1>
          <p className="text-[#FFFFFF75] text-[12px] md:text-[14px] leading-[130%] 2xl:text-[18px] w-[221px] md:w-auto mx-auto mb-[30px]">
            Last updated on September 12, 2023
          </p>
          <p className="text-[12px] md:text-[14px] leading-[140%] mx-auto md:mx-0 w-[80%] md:w-[100%] text-center 2xl:text-[15px] md:text-left lg:w-[90%] mb-[69px]">
            Below are our privacy & policy, which outline a lot of goodies. it’s
            our aim to always take of our participant
          </p>
          <div className="flex flex-col items-start w-[100%] lg:w-[100%] xl:w-[569px] 2xl:w-[80%] 2xl:h-auto h-[608px] lg:h-auto border-[#d434fe] border-[1px] rounded-[5px] py-[45px] md:py-[59px] px-[15px] md:px-[72px] lg:py-[30px] lg:px-[30px] 2xl:py-[80px] 2xl:px-[50px]">
            <p className="text-[12px] text-center md:text-left md:text-[14px] leading-[30px] mb-[24px] 2xl:text-[19px] 2xl:mb-[30px]">
            ...
            <h3 className="text-[#D434FE] text-[13px] md:text-[16px] 2xl:text-[22px] leading-[150%] font-bold">
              Licensing Policy
            </h3>
            ...
            <ul className={`${styles.privacyListItems}`}>
              <li className="text-[13px] md:text-[14px] leading-[150%] 2xl:text-[16px] mb-[14px]">
                The Standard License grants you a non-exclusive right to
                navigate and register for our event
              </li>
              <li className="text-[13px] md:text-[14px] leading-[150%] 2xl:text-[16px] mb-[30px]">
